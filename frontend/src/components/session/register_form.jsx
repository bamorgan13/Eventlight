...
class RegisterForm extends React.Component {
  ...
  render() {
    ...
    const show_full_name_label =
      this.state.full_name_focus || this.state.full_name
      ...
      <div className="register">
        <form onSubmit={this.handleSubmit} className="register__form">
          ...
          <div className="register__form__email">
            <div className={`register__form__email_label show`}>
              Email address
            </div>
            <input
              type="text"
          ...
          <div
            className={`register__form__full_name ${
              this.state.full_name_focus ? 'focused' : 'unfocused'
            }`}
          >
            <div
              className={`register__form__full_name_label ${
                show_full_name_label ? 'show' : ''
              } `}
            >
              Full name
            </div>
          ...
          >
            <div
              className={`register__form__password_label ${
