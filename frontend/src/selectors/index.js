...
export const numLiked = state =>
  state.session.isAuthenticated ? state.session.user.liked_events.length : 0

export const numRegistrations = state =>
  state.session.isAuthenticated ? state.session.user.registrations.length : 0
